                    ...
                    <div className="col-md-6">
                        <Card className="mb-3 mt-1">
                            ...
                            <CardFooter className="bg-white">
                                <div className="d-flex justify-content-center">
                                    <div>
                                        <h6 className="d-flex justify-content-start text-small" style={{ textColor: "grey" }}>{this.props.particularPostDetail.fname} {this.props.particularPostDetail.lname}</h6>
